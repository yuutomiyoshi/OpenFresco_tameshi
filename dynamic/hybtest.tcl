...
# pseudodynamic
#expControl NIDAQmx 1 50. 50. 0.1 1.
expControl NIDAQmx 1 25. 25. 0.1 1.

# fast
#expControl NIDAQmx 1 50. 50. 0.5 -1
...
set deltaT 0.01
set eqN 1
timeSeries Path 1001 -filePath input/eq$eqN.dat -dt $deltaT -factor 0.00008
...
recorder Node -file "eq$eqN/dspout.dat" -time -node 2 -dof 1 disp

# Create a recorder to monitor nodal acceleration
recorder Node -file "eq$eqN/accout.dat" -timeSeries 1001 -time -node 2 -dof 1 accel


# Create a recorder to monitor element forces
recorder Node -file "eq$eqN/reaction.dat" -time -node 1 -dof 1 reaction
recorder Node -file "eq$eqN/reaction_y.dat" -time -node 1 -dof 2 reaction
recorder Element -file "eq$eqN/frcoutex1.dat" -time -ele 1 globalForce
recorder Element -file "eq$eqN/defforce.dat" -time -ele 1 deformationsANDforces
